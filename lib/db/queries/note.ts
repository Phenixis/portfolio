...
export async function createNote(userId: string, title: string, content: string, projectTitle?: string) {
...
export async function updateNote(userId: string, id: number, title: string, content: string, projectTitle?: string) {
