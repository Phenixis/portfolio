...
export default function Header({ }: {}) {
	...
	return (
		<header
			className={cn(
				"fixed z-50 bottom-4 has-[:hover]:bottom-6 flex items-center justify-center w-full transition-all duration-300",
				isVisible ? "translate-y-0 opacity-100" : "translate-y-24 opacity-0",
			)}
		>
			<div className="relative w-fit max-w-[90%] p-1 xl:p-2 px-2 xl:px-4 bg-gray-50 dark:bg-gray-900 rounded-full flex items-center justify-between border border-gray-200 dark:border-gray-800 transition-all duration-300 group/Header shadow-md"
			...
			>
				...
				{/* Center content */}
				<div className="flex items-center justify-center gap-1 xl:gap-2 group/Time duration-300 h-6 group-hover/Header:h-12">
					<Meteo />
					<div>
						<Time
